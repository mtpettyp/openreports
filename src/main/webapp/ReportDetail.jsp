      ...
      <s:if test="reportParameter.type.equals('Date')">
       <td>
       	<s:if test="required && reportParameter.defaultValue == null">
      	 	<sx:datetimepicker name="%{reportParameter.name}" value="%{defaultDate}" displayFormat="%{dateFormat}"  />
        </s:if>
        <s:if test="reportParameter.defaultValue != null">
       		<sx:datetimepicker name="%{reportParameter.name}" value="%{reportParameter.defaultValue}" displayFormat="%{dateFormat}" />
        </s:if>
        <s:if test="!required && reportParameter.defaultValue == null">
       		<sx:datetimepicker name="%{reportParameter.name}" displayFormat="%{dateFormat}" />
        </s:if>
       </td>
      </s:if>
