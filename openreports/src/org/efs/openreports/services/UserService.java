...
{	
	 ...
	 * authenticate user
	 */	
	public boolean authenticate(UserInput user);
	
	/**
	 * Get a list of reports for a given user
	 */	
	public ReportInfo[] getReports(UserInput user);
	
	/**
	 * Get user information for a given user
	 */	
	public UserInfo getUserInfo(UserInput user);
	
	/**
	 * Update user information
	 */	
	public ServiceCallInfo updateUserInfo(UserInput user, UserInfo userInfo);
}
