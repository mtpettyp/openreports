...
create table REPORT (REPORT_ID int4 not null, NAME varchar(255) not null unique, DESCRIPTION varchar(255) not null, REPORT_FILE varchar(255) not null, PDF_EXPORT bool not null, CSV_EXPORT bool not null, XLS_EXPORT bool not null, HTML_EXPORT bool not null, RTF_EXPORT bool not null, TEXT_EXPORT bool not null, EXCEL_EXPORT bool not null, FILL_VIRTUAL bool not null, HIDDEN_REPORT bool not null, REPORT_QUERY text, DATASOURCE_ID int4, CHART_ID int4, EXPORT_OPTION_ID int4, primary key (REPORT_ID))
...
create table REPORT_LOG (LOG_ID int4 not null, START_TIME timestamp, END_TIME timestamp, STATUS varchar(255), MESSAGE text, REPORT_ID int4, USER_ID int4, ALERT_ID int4, primary key (LOG_ID))

create table REPORT_PARAMETER (PARAMETER_ID int4 not null, NAME varchar(255) not null unique, TYPE varchar(255) not null, CLASSNAME varchar(255) not null, DATA text, DATASOURCE_ID int4, DESCRIPTION varchar(255), REQUIRED bool, MULTI_SELECT bool, primary key (PARAMETER_ID))
