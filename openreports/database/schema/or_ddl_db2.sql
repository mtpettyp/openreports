...
create table REPORT_LOG (LOG_ID integer generated by default as identity, START_TIME timestamp, END_TIME timestamp, STATUS varchar(255), MESSAGE clob(255), REPORT_ID integer, USER_ID integer, ALERT_ID integer, primary key (LOG_ID))

create table REPORT_PARAMETER (PARAMETER_ID integer generated by default as identity, NAME varchar(255) not null unique, TYPE varchar(255) not null, CLASSNAME varchar(255) not null, DATA clob(255), DATASOURCE_ID integer, DESCRIPTION varchar(255), REQUIRED smallint, MULTI_SELECT smallint, primary key (PARAMETER_ID), unique (NAME))
