...
create table OR_TAGS (TAG_ID integer generated by default as identity (start with 1), TAGGED_OBJECT_ID integer not null, TAGGED_OBJECT_CLASS varchar(255) not null, TAG_VALUE varchar(255) not null, primary key (TAG_ID))
