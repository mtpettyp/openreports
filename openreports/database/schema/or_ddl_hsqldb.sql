...
create table REPORT_LOG (LOG_ID integer generated by default as identity (start with 1), START_TIME timestamp, END_TIME timestamp, STATUS varchar(255), MESSAGE longvarchar, REPORT_ID integer, USER_ID integer, ALERT_ID integer, primary key (LOG_ID))

create table REPORT_PARAMETER (PARAMETER_ID integer generated by default as identity (start with 1), NAME varchar(255) not null, TYPE varchar(255) not null, CLASSNAME varchar(255) not null, DATA longvarchar, DATASOURCE_ID integer, DESCRIPTION varchar(255), REQUIRED bit, MULTI_SELECT bit, primary key (PARAMETER_ID), unique (NAME))
